...
def store():
    ...
    while True:
        ...
        if choice == "1":
            ...
            break
store()
print(f"You have - Money Left: {supplies.money}, Snacks: {supplies.snacks}, Medicine: {supplies.medicine}, Fuel: {car.fuel}/{car.gas_tank_size}, Car Health: {car.health}, Phone Charge: {car.passengers[0].phone_battery}%")
time.sleep(3)
