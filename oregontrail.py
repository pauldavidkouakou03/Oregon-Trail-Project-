...
#Victory Function
def victory_ending():
    slow_print(victory_screen, 0.05)
    print("")
    print("================================== FINAL STATS ==================================")
    print(f"Miles Driven: {car.miles_driven}/1000")
    print(f"End Fuel: {car.fuel}/{car.gas_tank_size}    End Car Health: {car.health}/100")
    print(f"Money Left: {supplies.money}")
    print("\nPASSENGER STATS")
    print("=" * 81 + "")
    print(f"{'Name':<12} {'Status':<15} {'Hunger':<13} {'Phone Battery':<20} {'Final Condition'}")
    print("=" * 81 + "")
    for passenger in car.passengers:
        if passenger.status == "DEAD":
            if passenger.hunger < 0:
            ...
            condition = "Survived"
        print(f"{passenger.get_name():<12} {passenger.status:<16} {passenger.get_hunger():<17} {passenger.get_phone_battery():<18} {condition}")
    print("=" * 81 + "")
